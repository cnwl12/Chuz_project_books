...
<body>
    ...
    <section class="breadcrumb-section set-bg" data-setbg="img/books-001.jpg">
        <div class="container">
            <div class="row">
            	   ...
            	   <form action="insertPro.bs" method="post">
            	    <div class="row">
            	     ...
            	     <div class="checkout__input">
                       ...
                       <p>
                         <input type="text" placeholder="id는 최대 4자리 이상으로 작성" name="id"> <br />
                         <div><input type="button" value="중복확인" width="10" height="3"></div>
                    </div>
                         </p>
